...
**Статус (ночь 12→13.07.2026):** весь бэклог реализован в ветке main как версия **0.2.0 (unreleased)** — см. CHANGELOG.md. Тесты: 63, CI зелёный, документация: https://promsoft.github.io/stratindex/. **Публикация 0.2.0 на PyPI не выполнена — ждёт обсуждения** (для релиза достаточно `git tag v0.2.0 && git push origin v0.2.0`).
